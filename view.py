...
class View(tk.Tk):
	...
	def _make_temp_display(self):
		value_lbl = tk.Label(self.main_frm, textvariable=self.value_var, font=("Courrier", 40))
	...
	def _make_button(self):
		...
		btn = tk.Button(frm, textvariable=self.alarme_var, command=self.controller.on_off_alarme , font=("Courrier", 30))
